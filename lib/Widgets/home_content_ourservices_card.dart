    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: widget.isDark ? AppColors.bgDark : AppColors.bgLight,
          ...
          border: Border.all(
            color: widget.isDark ? AppColors.primaryDark : Colors.grey.shade100,
            width: 1,
          ),
        ),
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 12,
                  color: widget.isDark ? AppColors.textDark : Colors.grey[700],
                  fontFamily: 'Agency',
                ),
                maxLines: 3,
