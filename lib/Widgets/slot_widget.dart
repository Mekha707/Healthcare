    ...
    if (displaySlots.isEmpty) {
      return Center(
        child: Padding(
          ...
          child: Text(
            'No available slots',
            style: TextStyle(color: _secondaryText, fontFamily: 'Agency'),
          ),
        ),
      );
    }
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isActive ? const Color(0xFF0861dd) : _cardBg,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: isActive ? const Color(0xFF0861dd) : _borderColor,
                  width: 0.8,
                ),
              ),
              child: Column(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isHourSelected ? const Color(0xFF0861dd) : _cardBg,
