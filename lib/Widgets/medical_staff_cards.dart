...
class _UniversalMedicalCardState extends State<UniversalMedicalCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? AppColors.surfaceDark : AppColors.textDark,
  ...
  Widget _buildMatchIndicator(LabModel lab) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isFullMatch
            ? (isDark ? const Color(0xFF0F3D2E) : const Color(0xFFE1F5EE))
            : (isDark ? Colors.blueGrey.shade900 : Colors.blueGrey.shade50),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isFullMatch
              ? (isDark ? const Color(0xFF1A6B4A) : const Color(0xFFB2E2D1))
